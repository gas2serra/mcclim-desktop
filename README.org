...
(cl-desktop:initialize-manager)

(cl-desktop:launch-application 
         (cl-desktop:find-application "climacs"))

(launch-application 
         (find-application "climacs") 
         :args '("/etc/passwd"))
...
#+BEGIN_SRC lisp
(ql:quickload :cl-desktop) 
(ql:quickload :mcclim-desktop) ;; GUI
#+END_SRC
